...
*  CSCI964/CSCI464 Ass3 Autumn 2005
...
*  Ver4: Miles Tuffs -  1 April 2005 - 3, 4 & 5 layer mlp & test fn added
*  Copyright - University of Wollongong - 2005
*************************************************************************/

// Problems 2 and 3 |a-d|<0.5
...
int main(){
  ...
  if( NumIPs<1||NumIPs>MAXN||NumOPs<1||NumOPs>MAXN||
	...
	else if(NumHN==2 && (NumHN2<0||NumHN2>50))
	{ cout<<"Invalid specs in data file!\n"; exit(1); }
	else if(NumHN==3 && (NumHN3<0||NumHN3>50||NumHN2<0||NumHN2>50))
	{ cout<<"Invalid specs in data file!\n"; exit(1); }
